...
/**
 * Comparison test for otel-rules/nginx/nginx-instance.yaml.
 *
 * <p>This file exercises:
 * <ul>
 *   <li>expPrefix — tag closure: tags.service = 'nginx::' + tags.service</li>
 *   <li>Scope: instance(['service'], ['service_instance_id'], Layer.NGINX)</li>
 ...
 * </ul>
 */
class NginxInstanceTest extends MALScriptComparisonBase {

    private static final String YAML_PATH =
        "otel-rules/nginx/nginx-instance.yaml";
    ...
    /**
     * Build the full input map covering all sample names in nginx-instance.yaml.
     *
     * <pre>
     * # Scope labels (required by expPrefix tag closure and expSuffix):
     * #   service="my-nginx" (transformed to "nginx::my-nginx" by script)
     * #   service_instance_id="nginx-inst-1" (instance identifier)
     *
