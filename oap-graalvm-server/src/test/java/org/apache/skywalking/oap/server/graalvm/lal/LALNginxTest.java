...
/**
 * Pre-compilation test for lal/nginx.yaml.
 */
class LALNginxTest extends LALScriptComparisonBase {
    ...
    static void loadRules() throws Exception {
        RULES = loadLALRules("nginx.yaml");
    }

    @Test
    void allNginxRulesPrecompiled() {
        assertTrue(RULES.size() >= 1, "nginx.yaml should have at least 1 rule");
