...
/**
 * Comparison test for otel-rules/nginx/nginx-endpoint.yaml.
 *
 * <p>This file exercises:
 * <ul>
 *   <li>expPrefix — tag closure: tags.service = 'nginx::' + tags.service</li>
 *   <li>Scope: endpoint(['service'], ['route'], Layer.NGINX)</li>
 ...
 * </ul>
 */
class NginxEndpointTest extends MALScriptComparisonBase {

    private static final String YAML_PATH =
        "otel-rules/nginx/nginx-endpoint.yaml";
    ...
    /**
     * Build the full input map covering all sample names in nginx-endpoint.yaml.
     *
     * <pre>
     * # Scope labels (required by expPrefix tag closure and expSuffix):
     * #   service="my-nginx" (transformed to "nginx::my-nginx" by script)
     * #   route="/api/v1/users" (endpoint identifier)
     *
     * # --- Counter: total requests (multiple status samples for tagMatch) ---
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="200"} 5000.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="301"} 200.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="400"} 50.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="401"} 10.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="403"} 5.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="404"} 80.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="405"} 3.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="500"} 20.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="502"} 8.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="503"} 12.0
     * nginx_http_requests_total{service="my-nginx",route="/api/v1/users",status="504"} 2.0
     *
     * # --- Histogram: latency (le buckets) ---
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="0.005"} 10.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="0.01"} 25.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="0.025"} 50.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="0.05"} 80.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="0.1"} 120.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="0.25"} 180.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="0.5"} 220.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="1"} 260.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="2.5"} 285.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="5"} 295.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="10"} 299.0
     * nginx_http_latency{service="my-nginx",route="/api/v1/users",le="+Inf"} 300.0
     *
     * # --- Gauge: bandwidth by type ---
     * nginx_http_size_bytes{service="my-nginx",route="/api/v1/users",type="request"} 1048576.0
     * nginx_http_size_bytes{service="my-nginx",route="/api/v1/users",type="response"} 5242880.0
     * </pre>
     */
