...
/**
 * Comparison test for otel-rules/mysql/mysql-instance.yaml.
 *
 * This file exercises:
 * <ul>
 ...
 *   <li>Multi-sample subtraction — max_connections - threads_connected</li>
 *   <li>sum with aggregation labels — sum(['host_name','service_instance_id'])</li>
 *   <li>rate('PT1M') — on queries, commands, slow_queries</li>
 *   <li>Tag closure in expSuffix — tags.host_name = 'mysql::' + tags.host_name</li>
 *   <li>Scope: service(['host_name'], Layer.MYSQL).instance(['host_name'],
 *       ['service_instance_id'], Layer.MYSQL)</li>
 * </ul>
 */
class MysqlInstanceTest extends MALScriptComparisonBase {

    private static final String YAML_PATH =
        "otel-rules/mysql/mysql-instance.yaml";
    ...
    /**
     * Build the full input map covering all sample names in mysql-instance.yaml.
     ...
     *
     * # --- Passthrough metrics ---
     * mysql_global_status_uptime{host_name="mysql-host",service_instance_id="mysql:3306"} 86400.0
     * mysql_global_variables_innodb_buffer_pool_size{...} 134217728.0
     * mysql_global_variables_max_connections{...} 1000.0
     * mysql_global_variables_thread_cache_size{...} 16.0
     *
     * # --- Threads metrics ---
     * mysql_global_status_threads_connected{...} 50.0
     * mysql_global_status_threads_created{...} 120.0
     * mysql_global_status_threads_running{...} 5.0
     * mysql_global_status_threads_cached{...} 8.0
     * mysql_global_status_aborted_connects{...} 3.0
     *
    ...
    private static ImmutableMap<String, SampleFamily> buildInput(
        ...
        return ImmutableMap.<String, SampleFamily>builder()
            // Passthrough metrics
            .put("mysql_global_status_uptime",
                single("mysql_global_status_uptime",
                    scope, 86400.0 * scale, timestamp))
            .put("mysql_global_variables_innodb_buffer_pool_size",
                single("mysql_global_variables_innodb_buffer_pool_size",
            ...
            .put("mysql_global_variables_thread_cache_size",
                single("mysql_global_variables_thread_cache_size",
                    scope, 16.0, timestamp))
