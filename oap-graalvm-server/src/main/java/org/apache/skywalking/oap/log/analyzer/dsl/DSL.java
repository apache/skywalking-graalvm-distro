...
/**
 * GraalVM runtime replacement for upstream LAL DSL.
 * Same FQCN — shadows the upstream class via Maven classpath precedence.
 *
 * Instead of compiling Groovy at runtime, loads pre-compiled LAL script classes
 * from the classpath using a build-time manifest (keyed by SHA-256 hash of DSL string).
 */
@Slf4j
