 ...
 *
 * Upstream uses propertyMissing() delegate pattern + ExpandoMetaClass for Number ops.
 * This replacement is much simpler: MalExpression.run() already has all sample lookups
