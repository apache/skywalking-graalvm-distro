...
/**
 * GraalVM replacement for upstream StatusQueryConfig.
 * Original: skywalking/oap-server/server-query-plugin/status-query-plugin/src/main/java/.../debug/StatusQueryConfig.java
 * Repackaged into status-query-for-graalvm via maven-shade-plugin (replaces original .class in shaded JAR).
 *
