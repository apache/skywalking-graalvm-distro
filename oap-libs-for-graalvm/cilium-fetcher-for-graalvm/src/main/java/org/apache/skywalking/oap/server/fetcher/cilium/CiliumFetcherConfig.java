...
/**
 * GraalVM replacement for upstream CiliumFetcherConfig.
 * Original: skywalking/oap-server/server-fetcher-plugin/cilium-fetcher-plugin/src/main/java/.../cilium/CiliumFetcherConfig.java
 * Repackaged into cilium-fetcher-for-graalvm via maven-shade-plugin (replaces original .class in shaded JAR).
 *
