...
/**
 * GraalVM replacement for upstream AnalyzerModuleConfig.
 * Original: skywalking/oap-server/analyzer/agent-analyzer/src/main/java/.../provider/AnalyzerModuleConfig.java
