...
/**
 * GraalVM replacement for upstream EnvoyMetricReceiverConfig.
 * Original: skywalking/oap-server/server-receiver-plugin/envoy-metrics-receiver-plugin/src/main/java/.../envoy/EnvoyMetricReceiverConfig.java
 * Repackaged into envoy-metrics-receiver-for-graalvm via maven-shade-plugin (replaces original .class in shaded JAR).
 *
 * Change: Added @Setter at class level. Upstream only has @Getter on individual fields.
