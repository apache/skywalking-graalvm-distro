...
public class FilterSpec extends AbstractSpec {
    ...
    /**
     * No-arg json: parses JSON body with default settings (empty closure).
     */
    @SuppressWarnings("unused")
    public void json() {
        if (BINDING.get().shouldAbort()) {
    ...
    @SuppressWarnings("unused")
    public void text(final Consumer<TextParserSpec> body) {
        if (BINDING.get().shouldAbort()) {
            return;
        }
        body.accept(textParser);
    }

    @SuppressWarnings("unused")
    public void extractor(final Consumer<ExtractorSpec> body) {
        if (BINDING.get().shouldAbort()) {
            return;
        }
    ...
    @SuppressWarnings("unused")
    public void sink(final Consumer<SinkSpec> body) {
        if (BINDING.get().shouldAbort()) {
            return;
        }
        body.accept(sink);
    ...
    @SuppressWarnings("unused")
    public void filter(final Runnable body) {
        body.run();
    }
