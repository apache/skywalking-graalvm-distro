...
public abstract class HttpAlarmCallback implements AlarmCallback {
    private static final Logger LOGGER = LoggerFactory.getLogger(HttpAlarmCallback.class);
    ...
    protected String post(
        ...
        if (LOGGER.isDebugEnabled()) {
            LOGGER.debug("Sending alarm webhook POST to {}, body length: {}", uri, body.length());
        }
